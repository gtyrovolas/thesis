...
We denote that agent $a$ prefers outcome $d$ to $e$ as $d >_a e$. As in Grandi et al. we infer that if agent $a$ votes directly for outcome $d \in \{0, 1\}$ then agent $a$ prefers $d$ over any other outcome. 
