...
We collect the $n$ smart ballots into a smart profile $\mathbf{B}$. We illustrate the above in the following key example:

\begin{figure}[h]
    \centering
    \begin{tikzpicture}
        \tikzset{node distance=2cm and 1.75cm}
