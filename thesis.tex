...
\begin{proposition}
    Let $\mathcal{F}$ any class of computable 
\end{proposition}


Let $\lor$ be the binary logical OR and $\land$ be the binary logical AND. Then:
...
A similar construction is used to prove hardness of \textsc{BoundedMinMax}. 
